                ...
                <div class="nk-block">
                  <div class="card">
                    <div class="card-inner">
                      ...
                      ?>
                      <form action="control/categories/add_branch.php" method="POST" class="form-validate">
                        <div class="row g-gs">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label" for="fv-name">Main Category</label>
                              <div class="form-control-wrap">
                                <input type="number" class="form-control" id="fv-id" name="fv-id" value="" required placeholder="Enter category name" readonly>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
